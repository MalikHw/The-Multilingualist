...
class DSBorder : public CCLayerColor {
public:
    struct Padding {
        float top;
        float right;
    ...
    static DSBorder* create(cocos2d::CCNode* node, const cocos2d::ccColor4B& backgroundColor, const cocos2d::CCSize& size = { 0, 0 }, const cocos2d::CCPoint& padding = { 0, 0 });
...
protected:
    Padding m_padding;
    DSBorder(const cocos2d::CCPoint& padding = { 0, 0 });
